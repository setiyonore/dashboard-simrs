...
class MedicalRecordController extends Controller
{
    ...
    {
        //Jumlah pasien
        $px = DB::connection('mysql_khanza')->select("select poliklinik.devisi_poli,count(poliklinik.devisi_poli) as jumlah 
        from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli 
        where tgl_registrasi between '".$start."' and '".$end."'  group by poliklinik.devisi_poli ");
        
        // $nama_poli = array(); 
        // $jumlah = array();

        // foreach ($px as $key) {
        //     $nama_poli [] = $key->devisi_poli;
        //     $jumlah[] = $key->jumlah;
        // }
    ...
    public function getAppointments()
    {
        ...
        $px =  DB::connection('mysql_khanza')->select("select reg_periksa.kd_dokter, dokter.nm_dokter,  reg_periksa.no_rkm_medis  , poliklinik.devisi_poli, reg_periksa.tgl_registrasi  
