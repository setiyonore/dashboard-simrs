...
@section('title')
<title>Hutang Vendor Non Medis (Tanggal Datang)</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Hutang Vendor Non Medis (Tanggal Datang)</h1> 
          </div>
          <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">
                <a href="{{route('hutang_vendor_non_medis.home')}}">Hutang Vendor Non Medis</a>
              </li>
              <li class="breadcrumb-item active">Tanggal Datang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Hutang Vendor Non Medis<div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="hutang-vendor-non_medis" style="width: 100% !important">
                        <thead>
                            <tr>
                              <th>Kode Supplier</th>
                              <th>Nama Supplier</th>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#hutang-vendor-non_medis')) {
          datatableRalan = $('#hutang-vendor-non_medis').DataTable().destroy();
        }

        datatableRalan = $('#hutang-vendor-non_medis').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('hutang_vendor_non_medis.list_tgl_datang') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd,
