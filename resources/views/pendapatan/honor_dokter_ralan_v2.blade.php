...
@section('title')
<title>Honor Dokter Ralan v2</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Honor Dokter Jalan v2</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Honor Dokter Ralan v2</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Honor Dokter Rawat Jalan v2 <div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-tindakan-ralan-v2" style="width: 200% !important">
                        <thead>
                            <tr>
                              <th>Dokter</th>
                              <th>Penjamin</th>
                              ...
                              <th>Nama Tindakan</th>
                              <th>Poli</th>
                              <th>Pemeriksaan Ralan Umum</th>
                              <th>Tindakan Ralan Umum</th>
                              <th>Kolom Kosong</th>
                              <th>Pemeriksaan Ralan BPJS</th>
                              <th>Tindakan Ralan Bpjs</th>
                              <th>Kolom Kosong</th>
                              <th>Pemeriksaan Ralan Corporate</th>
                              <th>Tindakan Ralan Corporate</th>
                              <th>Kolom Kosong</th>
                            </tr>
                        </thead>
                    </table>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-tindakan-ralan-v2')) {
          datatableRalan = $('#data-tindakan-ralan-v2').DataTable().destroy();
        }

        datatableRalan = $('#data-tindakan-ralan-v2').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('pendapatan_v2.ralan.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
            ...
            columns:[
                ...
                { data: 'pemeriksaan_ralan_umum', name: 'pemeriksaan_ralan_umum'},
                { data: 'tindakan_ralan_umum', name: 'tindakan_ralan_umum'},
                { data: 'kolom_kosong_1', name: 'kolom_kosong_1'},
                { data: 'pemeriksaan_ralan_bpjs', name: 'pemeriksaan_ralan_bpjs'},
                { data: 'tindakan_ralan_bpjs', name: 'tindakan_ralan_bpjs'},
                { data: 'kolom_kosong_2', name: 'kolom_kosong_2'},
                { data: 'pemeriksaan_ralan_corporate', name: 'pemeriksaan_ralan_corporate'},
                { data: 'tindakan_ralan_corporate', name: 'tindakan_ralan_corporate'},
                { data: 'kolom_kosong_3', name: 'kolom_kosong_3'},
            ],  
          });
    });
