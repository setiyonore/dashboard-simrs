...
@section('title')
<title>Honor Anestesi Operasi v2</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tindakan Anestesi v2</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Tindakan Anestesi v2</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Tindakan Anestesi v2<div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-anestesi-v2" style="width: 200% !important">
                        <thead>
                            <tr>
                              <th>Anestesi</th>
                              <th>Penjamin</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="filter_doctor">@Lang('common.anestesi'):</label>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-anestesi-v2')) {
          datatableRalan = $('#data-anestesi-v2').DataTable().destroy();
        }

        datatableRalan = $('#data-anestesi-v2').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('pendapatan_v2.anestesi.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
            ...
            columns:[
                ...
                { data: 'anestesi_umum', name: 'anestesi_umum'},
                { data: 'kolom_kosong_3', name: 'kolom_kosong_3'},
                { data: 'kolom_kosong_4', name: 'kolom_kosong_4'},
                { data: 'anestesi_bpjs', name: 'anestesi_bpjs'},
                { data: 'kolom_kosong_5', name: 'kolom_kosong_5'},
                { data: 'kolom_kosong_6', name: 'kolom_kosong_6'},
                { data: 'anestesi_corporate', name: 'anestesi_corporate'},
