...
@section('title')
<title>Honor Dokter Ranap</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Honor Dokter Ranap</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Honor Dokter Ranap</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="honor_dokter_ranap" style="width: 200% !important">
                        <thead>
                            <tr>
                              <th>No. Rawat</th>
                              <th>Status Rawat</th>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#honor_dokter_ranap')) {
          datatableRalan = $('#honor_dokter_ranap').DataTable().destroy();
        }

        datatableRalan = $('#honor_dokter_ranap').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            columns:[
                ...
                { data: 'jam_rawat', name: 'jam_rawat'},
                { data: 'png_jawab', name: 'png_jawabruang'},
                { data: 'ruang', name: 'ruang'},
                { data: 'nm_perawatan', name: 'nm_perawatan'},
                { data: 'tarif_tindakandr', name: 'tarif_tindakandr'},
            ],
          });
    });
