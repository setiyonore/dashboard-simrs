  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Stok Keluar Medis</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Stok Keluar Medis</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Stok Keluar Medis<div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-stok-keluar-medis" style="width: 100% !important">
                        <thead>
                            <tr>
                              <th>Nota Jual</th>
                              <th>Tgl. Jual</th>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-stok-keluar-medis')) {
          datatableStokKeluarMedis = $('#data-stok-keluar-medis').DataTable().destroy();
        }

        datatableStokKeluarMedis = $('#data-stok-keluar-medis').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('manager.stokkeluarmedis.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd,
