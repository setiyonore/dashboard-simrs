  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pendapatan Penjualan Obat Bebas</h1> 
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Penjualan Obat Bebas<div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-penjualan-obat-bebas" style="width: 100% !important">
                        <thead>
                            <tr>
                              <th>Nota Jual</th>
                              <th>Tgl. Jual</th>
                              ...
                              <!-- <th>Harga Beli x Jumlah + PPN 11%</th> -->
                              <th>Harga Jual x Jumlah + PPN 11%</th>
                              <th>Jenis Jual</th>
                              <th>Petugas</th>
                              <th>Depo</th>
                              <th>Status</th>
...
$(document).ready(function () {
    var dateEnd;
    var dateStart;
    var datatablePenjualanObatBebas;
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-penjualan-obat-bebas')) {
          datatablePenjualanObatBebas = $('#data-penjualan-obat-bebas').DataTable().destroy();
        }

        datatablePenjualanObatBebas = $('#data-penjualan-obat-bebas').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('manager.penjualanobatbebas.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd,
            ...
            columns:[
                ...
                // { data: 'harga_beli_x_jml+ppn', name: 'harga_beli_x_jml+ppn' },
                { data: 'harga_jual_x_jml+ppn', name: 'harga_jual_x_jml+ppn'},
