...
@section('title')
<title>Grouper Rawat Jalan</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Grouper Rawat Jalan BPJS Kesehatan</h1> 
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Grouper Rawat Jalan BPJS Kesehatan<div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-grouper-ralan" style="width: 150% !important">
                        <thead>
                            <tr>
                              <th>No Rawat</th>
