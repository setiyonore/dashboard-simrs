...
@section('title')
<title>Hutang Vendor Non Medis (Tanggal Tempo)</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Hutang Vendor Non Medis (Tanggal Tempo)</h1> 
          </div>
          <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">
                <a href="{{route('hutang_vendor_farmasi.home')}}">Hutang Vendor Non Medis</a>
              </li>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        datatableRalan = $('#hutang-vendor-non_medis').DataTable({
            ...
            ajax:{
                url: "{{ route('hutang_vendor_non_medis.list_tgl_tempo') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd,
