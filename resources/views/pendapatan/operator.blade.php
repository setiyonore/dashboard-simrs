...
@section('title')
<title>Honor Operator Operasi</title>
@endsection
          ...
          <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="honor_operator" style="width: 200% !important">
                        <thead>
                            <tr>
                              <th>No. Rawat</th>
                              <th>Nota Ralan</th>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#honor_operator')) {
          datatableRalan = $('#honor_operator').DataTable().destroy();
        }

        datatableRalan = $('#honor_operator').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
