                    ...
                    <table class="table table-hover table-striped" id="data-tindakan-laborat" style="width: 100% !important">
                        <thead>
                            <tr>
                              ...
                              <th>Tindakan Lab PK</th>
                              <th>Tindakan Lab PA</th>
                              <th>Biaya</th>
                              <th>SEP</th>
                              <th>Devisi</th>
                            </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="filter_doctor">@Lang('common.doctor_perujuk'):</label>
    ...
    $('#submit-filter').click(function(e) {
        ...
        datatableLaborat = $('#data-tindakan-laborat').DataTable({
            ...
            columns:[
                ...
                { data: 'tgl_periksa_lab', name: 'tgl_periksa_lab',
                    render: data => {
                ...
                { data: 'dokter_perujuk', name: 'dokter_perujuk'},
                { data: 'tindakan_lab_PK', name: 'tindakan_lab_PK'},
                { data: 'tindakan_lab_PA', name: 'tindakan_lab_PA'},
